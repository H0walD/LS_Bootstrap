...
case 'delete' :
   ...
   elseif ($menu->get(3) != '' AND $menu->get(4) == 's') { $_POST['delsids'][] = $menu->get(3); }
      if ( empty($_POST['delids']) AND empty($_POST['delsids'])) {
	      echo '<div class="alert alert-info">Es wurde keine Nachricht zum l&ouml;schen gew&auml;hlt</div><br>';
		    echo '<a class="btn btn-primary" href="javascript:history.back(-1)">zur&uuml;ck</a>';
      } else {
