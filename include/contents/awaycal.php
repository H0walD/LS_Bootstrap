...
while($r = db_fetch_assoc($erg)) {
  ...
  if ($r['uid'] == $_SESSION['authid'] OR is_siteadmin('awaycal')) {
    $r['betreff'] .= '<br><span style="float: right;"><a href="index.php?awaycal-d'.$r['id'].'" rel="tooltip" title="Eintrag löschen"><i class="fa fa-times-circle"></i></a> - <a href="index.php?awaycal-e'.$r['id'].'" rel="tooltip" title="editieren"><i class="fa fa-pencil-square-o"></i></a>';
    if (is_siteadmin('awaycal')) {
      $r['betreff'] .= ' - <a href="index.php?awaycal-c'.$r['id'].'-1" rel="tooltip" title="ablehnen"><i class="fa fa-thumbs-o-down"></i></a> - <a href="index.php?awaycal-c'.$r['id'].'-3" rel="tooltip" title="genehmigen"><i class="fa fa-thumbs-o-up"></i></a>';
    }
    $r['betreff'] .= '</span>';
  }
  $tpl->set_ar_out($r,2);
